...
const PATHS = {
  ...
  send: (
    <>
      <path d="M21 3 3.5 10.2l7 2.9 2.9 7L21 3z" />
      <path d="m10.5 13.1 5-5" />
    </>
  ),
  ...
  terminal: (
    <>
      ...
      <path d="m7 9.5 2.5 2.5L7 14.5M12.5 14.5h4" />
    </>
  ),
...
export function Icon({ name, filled = false, size = 15 }: { name: IconName; filled?: boolean; size?: number }) {
  return (
    <svg
      width={size}
      height={size}
